...
export const appData = createReducer(
  {
    categories: {},
    attributesMap: {},
    subItems: {},
  },
  {
    ...
    [ActionTypes.ADD_NEW_CATEGORY](state: any) {
    ...
    [ActionTypes.UPDATE_CATEGORY_TITLE](state: any, action: Action) {
      const newState = produce(state, (draft: any) => {
    ...
    [ActionTypes.UPDATE_ATTRIBUTES_TITLE](state: any, action: Action) {
      const newState = produce(state, (draft: any) => {
    ...
    [ActionTypes.UPDATE_ATTRIBUTES_DATA_TYPE](state: any, action: Action) {
      const newState = produce(state, (draft: any) => {
    ...
    [ActionTypes.ADD_NEW_ATTRIBUTE](state: any, action: Action) {
      const newState = produce(state, (draft: any) => {
    ...
    [ActionTypes.DELETE_ATTRIBUTE](state: any, action: Action) {
      const newState = produce(state, (draft: any) => {
    ...
    [ActionTypes.DELETE_CATEGORY](state: any, action: Action) {
      const newState = produce(state, (draft: any) => {
    ...
    [ActionTypes.UPDATE_CATEGORY_TITLE_FIELD](state: any, action: Action) {
      const newState = produce(state, (draft: any) => {
    ...
    [ActionTypes.ADD_NEW_ITEM_TO_SUBLIST](state: any, action: Action) {
    ...
    [ActionTypes.UPDATE_ITEM_ATTRIBUTES_VALUE](state: any, action: Action) {
      const newState = produce(state, (draft: AppData) => {
    ...
    [ActionTypes.DELETE_SUB_ITEM](state: any, action: Action) {
      const newState = produce(state, (draft: AppData) => {
